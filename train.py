...
parser.add_argument("--dataroot", type=str, default="./data/train/DAVIS")
parser.add_argument("--dataroot_val", type=str, default="./data/train/DAVIS_val")
...
if __name__ == "__main__":
    ...
    dataroot = f"./data/train/{used_dataset}"
    dataroot_val = f"./data/train/{val_used_dataset}"
